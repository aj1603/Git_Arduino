...
IPAddress staticIP(192, 168, 0, 211); //ESP static ip
...
String payload;
String device_key = "some_magic_word_10";
...
void handleDevice() {
  ...
  if (command.length() > 0) {
    ...
    if (command == "0") {
      ...
      irsend.sendNEC(0x804EE01F, 32);
      delay(2000);
      irsend.sendNEC(0x804E7A85, 32);
      delay(1000);
      irsend.sendNEC(0x804E7A85, 32);
      delay(1000);
      irsend.sendNEC(0x804EFA05, 32);
      delay(3000);
      irsend.sendNEC(0x804E02FD, 32);
      delay(1000);
      irsend.sendNEC(0x804E02FD, 32);
      delay(1000);
      irsend.sendNEC(0x804EFA05, 32);
