...
IPAddress staticIP(192, 168, 43, 105);
...
String submit_input_on = "<input type=\"submit\" style=\"border-radius: 50px 50px 50px 50px;text-align:center;height:150px;font-size:50px;width:400px;color:white;background-color: #00A8A9\" value=\"Open\">";

String control_input_off = "<input type=\"hidden\" name=\"control_input\" value=\"0\"></br>";
String submit_input_off = "<input type=\"submit\" style=\"border-radius: 50px 50px 50px 50px;text-align:center;height:150px;font-size:50px;width:400px;color:white;background-color: #f15d3c\" value=\"Close\">";
