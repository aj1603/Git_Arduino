...
IPAddress staticIP(192, 168, 7, 31 ); //ESP static ip
IPAddress gateway(192, 168, 7, 1);   //IP Address of your WiFi Router (Gateway)
...
String serverUrl = "192.168.7.252";
String payload;
String device_key = "watersensor_hash";
